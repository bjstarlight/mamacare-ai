...
getContractFactory(name: 'MedicalRecordV2', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.MedicalRecordV2__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'MedicalRecordV2', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.MedicalRecordV2>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'MedicalRecordV2', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MedicalRecordV2>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'MedicalRecordV2', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MedicalRecordV2>
